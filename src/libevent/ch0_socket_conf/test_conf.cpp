...
void listen_cb(evconnlistener *ev, evutil_socket_t s, struct sockaddr *addr,
               int socklen, void *arg) {
    // 我给加了定时器，2s 内没有新连接会断开，原代码只有 cout 这句 
...
int main() {
    ...
    if (!base) {
        ...
        evconnlistener *ev =
            evconnlistener_new_bind(base, listen_cb, base, 10,
